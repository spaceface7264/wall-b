-- Fixed RLS Policies for Chat - No Recursion
...
-- Fixed policies for conversations
...
-- Fixed policies for conversation_participants - NO RECURSION
...
-- Fixed policies for direct_messages
