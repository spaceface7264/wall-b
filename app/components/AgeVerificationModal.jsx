      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center gap-2">
            <Shield className="w-5 h-5 text-[#087E8B]" />
            ...
            {useDOB && (
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  max={maxDateString}
                  disabled={submitting}
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#087E8B] focus:border-transparent disabled:opacity-50"
                />
              </div>
            )}
          </div>
