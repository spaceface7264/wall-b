...
export default function SimpleEventCard({ event, onRSVP, rsvpStatus = null }) {
  ...
  const getRSVPButtonClass = () => {
    switch (rsvpStatus) {
      ...
      default:
        return 'bg-accent-blue hover:bg-accent-blue-hover text-white';
    }
  };
  ...
  return (
    <div className="mobile-card cursor-pointer hover:border-accent-blue/50 transition-all duration-200">
