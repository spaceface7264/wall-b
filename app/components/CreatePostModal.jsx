        ...
        <div className="flex-1 p-6 md:p-4 flex flex-col min-h-0 overflow-y-auto">
          ...
          <div className="flex items-center justify-between py-2">
            ...
            <button
              ...
              className="bg-accent-blue hover:bg-accent-blue-hover disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-6 py-2 rounded-lg font-medium transition-colors flex items-center gap-2"
