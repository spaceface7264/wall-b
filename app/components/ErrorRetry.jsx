    ...
    <div className="minimal-flex-center h-64">
      <div className="text-center max-w-md mx-auto px-4">
        ...
        <button
          ...
          className="px-6 py-3 bg-accent-blue text-white rounded-lg hover:bg-accent-blue-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2 mx-auto"
        >
          {retrying ? (
            <>
