        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            <div className="p-8 text-center">
              <div className="w-8 h-8 border-2 border-[#087E8B] border-t-transparent rounded-full animate-spin mx-auto mb-2"></div>
                ...
                return (
                  <div
                    ...
                    className={`cursor-pointer transition-colors p-4 hover:bg-gray-800/50 ${
                      isSelected ? 'bg-[#087E8B]/20 border-l-2 border-[#087E8B]' : ''
                    }`}
                  >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {gym.distance_km !== null && gym.distance_km !== undefined && (
                          <div className="flex items-center gap-1 mt-1">
                            ...
                            <span className="text-xs text-[#087E8B] font-medium">
