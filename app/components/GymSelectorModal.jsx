        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            <div className="p-8 text-center">
              <div className="w-8 h-8 border-2 border-[#2663EB] border-t-transparent rounded-full animate-spin mx-auto mb-2"></div>
                ...
                return (
                  <div
                    ...
                    className={`cursor-pointer transition-colors p-4 hover:bg-gray-800/50 ${
                      isSelected ? 'bg-[#2663EB]/20 border-l-2 border-[#2663EB]' : ''
                    }`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      >
                        ...
                        <div 
                          className="w-full h-full bg-gradient-to-br from-[#2663EB] to-[#2663EB] flex items-center justify-center"
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-1">
                          ...
                          {isSelected && (
                            <Check className="w-5 h-5 text-[#2663EB] flex-shrink-0" />
                          )}
                        </div>
                        ...
                        {gym.distance_km !== null && gym.distance_km !== undefined && (
                          <div className="flex items-center gap-1 mt-1">
                            <Navigation className="w-3 h-3 text-[#2663EB]" />
                            <span className="text-xs text-[#2663EB] font-medium">
