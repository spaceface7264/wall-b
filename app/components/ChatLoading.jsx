    ...
    <div className="flex items-center justify-center h-[calc(100vh-56px)] w-full">
      <div className="text-center space-y-6">
        ...
        <div className="relative">
          <div className="bg-gradient-to-br from-accent-blue to-accent-blue-hover rounded-full w-20 h-20 flex items-center justify-center mx-auto shadow-lg">
          ...
          <div className="absolute top-1/2 -left-3 w-2 h-2 bg-accent-blue rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-center space-x-1">
            ...
            <div className="flex space-x-1">
              <div className="w-1 h-1 bg-accent-blue rounded-full animate-bounce"></div>
              <div className="w-1 h-1 bg-accent-blue rounded-full animate-bounce" style={{ animationDelay: '0.1s' }}></div>
        ...
        <div className="w-48 mx-auto">
          <div className="bg-slate-700 rounded-full h-1 overflow-hidden">
            <div className="bg-gradient-to-r from-accent-blue to-accent-blue-hover h-full rounded-full animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
