        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 relative">
            <textarea
              ...
              autoFocus={autoFocus}
              className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-2.5 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2663EB] focus:border-transparent resize-none pr-12"
              rows={1}
              disabled={submitting}
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-[#2663EB] hover:text-[#2663EB] disabled:text-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              type="button"
            >
              {submitting ? (
