                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isSelected
                        ? 'border-accent-blue bg-accent-blue/15 shadow-lg shadow-accent-blue/20'
                    ...
                    `}
                  >
                    <Icon className={`w-6 h-6 mb-2 transition-colors duration-200 ${isSelected ? 'text-accent-blue' : 'text-gray-400'}`} />
