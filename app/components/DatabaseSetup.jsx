      ...
      <div className="max-w-4xl mx-auto text-white">
        <div className="flex items-start justify-between mb-4">
          ...
          <button
            ...
            className="px-3 py-1 bg-[#2663EB] text-white text-sm rounded hover:bg-[#1e4fd4] transition-colors"
          >
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1 bg-[#2663EB] text-white text-sm rounded hover:bg-[#1e4fd4] transition-colors"
                >
