        ...
        <div className="p-4">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00d4ff] focus:border-transparent"
            />
          </div>
              ...
              {filteredUsers.map((user) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    {/* Start Chat Button */}
                    <div className="p-2 text-[#00d4ff] hover:text-[#00d4ff] transition-colors">
