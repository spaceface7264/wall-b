      ...
      <div className={`${depth === 1 ? 'p-3' : 'w-full border-b border-gray-700/50 last:border-b-0 hover:bg-gray-800/30'} transition-all duration-200`} style={depth !== 1 ? { padding: '16px 0' } : {}}>
        ...
        <div className="minimal-flex justify-between items-start mb-2" style={{ padding: depth !== 1 ? '0 16px' : '0' }}>
          <div className="minimal-flex gap-2">
            ...
            <div 
              className="w-9 h-9 bg-gradient-to-br from-[#00d4ff] to-[#00d4ff] rounded-full minimal-flex-center flex-shrink-0 cursor-pointer"
            ...
            <div>
              <button
                onClick={(e) => handleProfileClick(e, comment.user_id)}
                className="mobile-text-sm font-semibold text-[#00d4ff] hover:text-[#00b8e6] transition-colors text-left"
                style={{ fontSize: '14px' }}
              >
        ...
        {!isEditing && (
          <div className="minimal-flex gap-4 items-center" style={{ padding: depth !== 1 ? '0 16px' : '0' }}>
            ...
            {canReply && (
              <button
                onClick={handleReply}
                className="icon-button minimal-flex gap-1 text-white hover:text-[#00d4ff]"
              >
            ...
            {hasReplies && (
              <button
                ...
                className="minimal-flex gap-1 text-gray-400 hover:text-[#00d4ff]"
              >
                {showReplies ? (
        ...
        {hasReplies && showReplies && (
          <div className="mt-4 pt-4">
            ...
            {replies.map((reply) => (
              <div key={reply.id} className="ml-6 pl-4 border-l-2 border-[#00d4ff]/30 relative">
                <div className="absolute -left-1 top-0 w-2 h-2 bg-[#00d4ff] rounded-full"></div>
