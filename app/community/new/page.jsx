        ...
        <div className="mobile-section">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <label className="relative cursor-pointer group">
                    ...
                    <div className={`p-4 rounded-xl border-2 transition-all duration-200 ${
                      formData.community_type === 'gym' 
                        ? 'bg-[#2663EB]/15 border-[#2663EB] shadow-lg shadow-[#2663EB]/20' 
                      ...
                      <div className="flex items-center gap-3">
                        <Building className={`w-5 h-5 transition-colors duration-200 ${
                          formData.community_type === 'gym' ? 'text-[#2663EB]' : 'text-gray-400'
                        }`} />
                    ...
                    <div className={`p-4 rounded-xl border-2 transition-all duration-200 ${
                      ...
                      <div className="flex items-center gap-3">
                        <Users className={`w-5 h-5 transition-colors duration-200 ${
                          formData.community_type === 'general' ? 'text-[#2663EB]' : 'text-gray-400'
                        }`} />
                        <div className="flex-1">
                          <div className={`font-semibold mb-1 transition-colors duration-200 ${
              ...
              <div>
                ...
                <input
                  ...
                  className={`minimal-input w-full transition-all duration-200 ${
                    errors.name ? 'border-red-500 focus:border-red-500' : 'focus:border-[#2663EB]'
                  }`}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`minimal-input w-full resize-none transition-all duration-200 ${
                    errors.description ? 'border-red-500 focus:border-red-500' : 'focus:border-[#2663EB]'
                  }`}
                />
                <div className="flex items-center justify-between mt-1">
                  {errors.description ? (
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  maxLength={1000}
                  className="minimal-input w-full resize-none transition-all duration-200 focus:border-[#2663EB]"
                />
                <div className="flex items-center justify-between mt-1">
                  <p className="text-xs text-gray-500">
                ...
                <div className="space-y-3">
                  <label className="flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition-all duration-200 hover:border-gray-600 bg-gray-800/40 border-gray-700/50">
                    ...
                    <div className={`p-2 rounded-lg transition-colors duration-200 ${
                      !formData.is_private ? 'bg-[#2663EB]/20' : 'bg-gray-700/50'
                    }`}>
                      <Globe className={`w-5 h-5 transition-colors duration-200 ${
                        !formData.is_private ? 'text-[#2663EB]' : 'text-gray-400'
                      }`} />
                    </div>
                    <div className="flex-1">
                      <div className={`font-semibold mb-1 transition-colors duration-200 ${
                    ...
                    {!formData.is_private && (
                      <div className="flex-shrink-0">
                        <div className="w-5 h-5 rounded-full bg-[#2663EB] flex items-center justify-center">
          ...
          <div className="mobile-card p-5 mt-6 bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50">
            <div className="flex items-start gap-3">
              <div className="p-2 rounded-lg bg-[#2663EB]/20 flex-shrink-0">
                <Info className="w-5 h-5 text-[#2663EB]" />
              </div>
              <div className="flex-1">
                <h4 className="text-sm font-semibold text-white mb-2">Tips for Creating a Great Community</h4>
                <ul className="text-sm text-gray-300 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-[#2663EB] mt-0.5">•</span>
